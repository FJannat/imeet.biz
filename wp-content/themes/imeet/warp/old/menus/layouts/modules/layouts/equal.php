...
switch (count($modules)) {
	...
	case 6:
		...
		printf('<div class="grid-box width32 grid-h">%s</div>', $modules[0]);

		printf('<div class="grid-box width16 grid-h">%s</div>', $modules[1]);

		printf('<div class="grid-box width13 grid-h">%s</div>', $modules[2]);

		printf('<div class="grid-box width13 grid-h">%s</div>', $modules[3]);

		printf('<div class="grid-box width13 grid-h">%s</div>', $modules[4]);

		printf('<div class="grid-box width13 grid-h">%s</div>', $modules[5]);
