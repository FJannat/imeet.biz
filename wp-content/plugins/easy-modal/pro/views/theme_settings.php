...
?><div style="border-style:" class="wrap">
	...
	<?php screen_icon()?>
	<h2>
		<?php echo ucfirst(esc_html($settings['name'])).' '; _e('Theme','easy-modal')?>
		<a style="color:#fff;border:1px solid #333; background-color:#21759B; text-shadow: none;"class="add-new-h2" href="admin.php?page=<?php echo EASYMODAL_SLUG?>-themes&theme_id=<?php echo intval($theme_id)?>&action=clone&safe_csrf_nonce_easy_modal=<?php echo wp_create_nonce("safe_csrf_nonce_easy_modal")?>">Clone</a>
		<?php if($theme_id != 1){?>
		<a style="color:#fff;border:1px solid #333; background-color:#900; text-shadow: none;"class="add-new-h2" href="admin.php?page=<?php echo EASYMODAL_SLUG?>-themes&theme_id=<?php echo intval($theme_id)?>&action=delete&safe_csrf_nonce_easy_modal=<?php echo wp_create_nonce("safe_csrf_nonce_easy_modal")?>">Delete</a>
		<?php }?>
	</h2>
	<div><<< - <a href="admin.php?page=<?php echo EASYMODAL_SLUG?>-themes">Back to Theme Lists</a></div>
	<div class="emthemes metabox-holder">
		<div class="meta-box-sortables ui-sortable">
			...
			<div class="tabwrapper">
				<form method="post" action="admin.php?page=easy-modal-themes&theme_id=<?php esc_attr_e($theme_id)?>">
